...
segment_file('data/Teko/data/eme_dev_unseg.txt', 'data/Teko/data/eme_dev_res-cfg19.txt', segmentation_model, ' ', ' ', False, None , 1)
segment_file('data/Teko/data/eme_test_unseg.txt', 'data/Teko/data/eme_test_res-cfg19.txt', segmentation_model, ' ', ' ', False, None , 1)

# data set and output statistics
gold_path = 'data/Teko/data/eme_dev_true.txt'
