...
# the path to SFG used (for this project, the basic one)
grammar_path = 'data/Teko/grammar/standard/grammar0.txt'
# the path to the SFG used + appended Hex-encoded chars as terminals
final_grammar_path = 'data/Teko/grammar/standard/final_grammar.txt'
